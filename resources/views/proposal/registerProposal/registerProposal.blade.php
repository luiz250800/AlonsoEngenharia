    ...
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body text-left">
                ...
                <form method="POST" action="/proposal/register" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="cliente">Cliente</label>
                        <select class="form-control" id="cdCliente" name="cdCliente">
                            @foreach($clientes as $cliente)
                            <option value={{$cliente->cd_cliente}}>{{$cliente->nm_fantasia_cliente}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nmEndereco" name="nmEndereco" placeholder="Digite o endereço da obra" maxlength="80">
                        <small id="enderecoHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="vlTotal">Valor total</label>
                        <input type="text" class="form-control" id="vlTotal" name="vlTotal" placeholder="Digite o valor total da proposta" maxlength="9">
                        <small id="vlTotalHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="sinal">Sinal</label>
                        <input type="text" class="form-control" id="vlSinal" name="vlSinal" placeholder="Digite o valor do sinal" maxlength="8">
                        <small id="sinalHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="quantidadeParcela">Quantidade de parcelas</label>
                        <input type="number" class="form-control" id="qtParcela" name="qtParcela" placeholder="Digite a quantidade de parcelas" maxlength="3">
                        <small id="quantidadeParcelaHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="valorParcela">Valor das parcelas</label>
                        <input type="text" class="form-control" id="vlParcela" name="vlParcela" placeholder="Digite o valor das parcelas" maxlength="9">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="dtInicioPagamento" name="dtInicioPagamento" placeholder="dd-mm-yyyy" value=""
                               min="1997-01-01" max="2030-12-31">
                        <small id="dataInicioPagamentoHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="dataParcela">Data das parcelas</label>
                        <input type="date" class="form-control" id="dtParcela" name="dtParcela" placeholder="Digite a data das parcelas">
                    ...
                    <div class="form-group">
                        ...
                        <small id="anexoArquivoHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
