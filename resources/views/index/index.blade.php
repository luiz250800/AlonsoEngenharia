...
<form class="form-signin" method="POST" action="/login">
    ...
    @csrf
    <input type="email" id="nmEmail" name="nmEmail" class="form-control" placeholder="Digite seu e-mail" required="" autofocus="" maxlength="50">
    ...
    <a href="/login/register" class="text-warning">Não é cadastrado? Cadastre-se!</a>
</form>
